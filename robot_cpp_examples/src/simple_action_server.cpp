...
private:
  ...
  rclcpp_action::GoalResponse goalCallback(
      ...
      std::shared_ptr<const robot_msgs::action::Fibonacci::Goal> goal)
  {
  ...
  rclcpp_action::CancelResponse cancelCallback(
      const std::shared_ptr<rclcpp_action::ServerGoalHandle<robot_msgs::action::Fibonacci>> goal_handle)
  {
...
RCLCPP_COMPONENTS_REGISTER_NODE(robot_cpp_examples::SimpleActionServer)
